...
class Unused
  ...
  def filter_items(items)
    items.select { |f| 
      !f.name.start_with?("test") && !f.modifiers.include?("@IBAction") && !f.modifiers.include?("override") && !f.modifiers.include?("@objc") && !f.modifiers.include?("@IBInspectable") && !f.modifiers.include?("@main") && !f.name.include?("CodingKeys") && !f.name.include?("Previews") && !f.name.include?("applicationWillTerminate") && !f.name.include?("makeUIView") && !f.name.include?("updateUIView") && !f.name.include?("makeCoordinator") && !f.name.include?("mailComposeController")}
  end
